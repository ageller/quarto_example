...
## Interactive contour plot with linear fit lines created with [`ggplot2`](https://ggplot2.tidyverse.org/) and [`plotly`](https://plotly.com/ggplot2/) using R (@fig-iris-Rplotly).
...
#| fig-cap: "Interactive scatter plot showing iris flower data."
#| warning: false
